...
const Addproduct = async (req, res) => {
  ...
  try {
    ...
    const newProduct = await Product.create({
      ...
      category,
      variant,
      price,productKey,description,sku,stock,minStock,images: uploadedImages
    });
...
const Updateproduct = async (req, res) => {
    const { id } = req.params;
    const { name, category, variant, price, productKey, description, sku, stock, minStock, imageUrl, publicId } = req.body;
